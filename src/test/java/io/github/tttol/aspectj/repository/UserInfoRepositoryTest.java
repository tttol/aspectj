...
public class UserInfoRepositoryTest {
    ...
    void init() {
        final var insertOperation = Operations.insertInto("user_info")
                ...
                .values(Hashing.sha256().hashString("1", StandardCharsets.UTF_8).toString(), "Tom", "tom@example.com")
                .values(Hashing.sha256().hashString("2", StandardCharsets.UTF_8).toString(), "John", "john@example.com")
                .build();
    ...
    class SelectAll {
        ...
        void selectAllTest() {
            ...
            user1.setId(Hashing.sha256().hashString("1", StandardCharsets.UTF_8).toString());
            user1.setName("Tom");
            user1.setEmail("tom@example.com");
            final var user2 = new UserInfo();
            user2.setId(Hashing.sha256().hashString("2", StandardCharsets.UTF_8).toString());
            user2.setName("John");
